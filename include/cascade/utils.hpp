...
/* For SignatureCascadeStore:
 * ::put():
 *      TLT_SIGNATURE_PUT_START
 *      TLT_SIGNATURE_ORDERED_PUT_START
 *      TLT_SIGNATURE_ORDERED_PUT_END
 *      TLT_SIGNATURE_PUT_END
 * ::put_and_forget():
 *      TLT_SIGNATURE_PUT_AND_FORGET_START
 *      TLT_SIGNATURE_ORDERED_PUT_AND_FORGET_START
 *      TLT_SIGNATURE_ORDERED_PUT_AND_FORGET_END
 *      TLT_SIGNATURE_PUT_AND_FORGET_END
 * ::trigger_put():
 *      TLT_SIGNATURE_TRIGGER_PUT_START
 *      TLT_SIGNATURE_TRIGGER_PUT_END
 * ::remove():
 *      TLT_SIGNATURE_REMOVE_START
 *      TLT_SIGNATURE_ORDERED_REMOVE_START
 *      TLT_SIGNATURE_ORDERED_REMOVE_END
 *      TLT_SIGNATURE_REMOVE_END
 * ::get():
 *      TLT_SIGNATURE_GET_START
 *      TLT_SIGNATURE_GET_END
 * ::multi_get():
 *      TLT_SIGNATURE_MULTI_GET_START
 *      TLT_SIGNATURE_ORDERED_GET_START
 *      TLT_SIGNATURE_ORDERED_GET_END
 *      TLT_SIGNATURE_MULTI_GET_END
 * ::list_keys():
 *      TLT_SIGNATURE_LIST_KEYS_START
 *      TLT_SIGNATURE_LIST_KEYS_END
 * ::multi_list_keys():
 *      TLT_SIGNATURE_MULTI_LIST_KEYS_START
 *      TLT_SIGNATURE_ORDERED_LIST_KEYS_START
 *      TLT_SIGNATURE_ORDERED_LIST_KEYS_END
 *      TLT_SIGNATURE_MULTI_LIST_KEYS_END
 * ::get_size():
 *      TLT_SIGNATURE_GET_SIZE_START
 *      TLT_SIGNATURE_GET_SIZE_END
 * ::multi_get_size():
 *      TLT_SIGNATURE_MULTI_GET_SIZE_START
 *      TLT_SIGNATURE_ORDERED_GET_SIZE_START
 *      TLT_SIGNATURE_ORDERED_GET_SIZE_END
 *      TLT_SIGNATURE_MULTI_GET_SIZE_END
 */
#define TLT_SIGNATURE_PUT_START                    (3101)
#define TLT_SIGNATURE_ORDERED_PUT_START            (3102)
#define TLT_SIGNATURE_ORDERED_PUT_END              (3103)
#define TLT_SIGNATURE_PUT_END                      (3104)

#define TLT_SIGNATURE_PUT_AND_FORGET_START         (3111)
#define TLT_SIGNATURE_ORDERED_PUT_AND_FORGET_START (3112)
#define TLT_SIGNATURE_ORDERED_PUT_AND_FORGET_END   (3113)
#define TLT_SIGNATURE_PUT_AND_FORGET_END           (3114)

#define TLT_SIGNATURE_TRIGGER_PUT_START            (3121)
#define TLT_SIGNATURE_TRIGGER_PUT_END              (3122)

#define TLT_SIGNATURE_REMOVE_START                 (3131)
#define TLT_SIGNATURE_ORDERED_REMOVE_START         (3132)
#define TLT_SIGNATURE_ORDERED_REMOVE_END           (3133)
#define TLT_SIGNATURE_REMOVE_END                   (3134)

#define TLT_SIGNATURE_GET_START                    (3141)
#define TLT_SIGNATURE_GET_END                      (3142)

#define TLT_SIGNATURE_MULTI_GET_START              (3151)
#define TLT_SIGNATURE_ORDERED_GET_START            (3152)
#define TLT_SIGNATURE_ORDERED_GET_END              (3153)
#define TLT_SIGNATURE_MULTI_GET_END                (3154)

#define TLT_SIGNATURE_LIST_KEYS_START              (3161)
#define TLT_SIGNATURE_LIST_KEYS_END                (3162)

#define TLT_SIGNATURE_MULTI_LIST_KEYS_START        (3171)
#define TLT_SIGNATURE_ORDERED_LIST_KEYS_START      (3172)
#define TLT_SIGNATURE_ORDERED_LIST_KEYS_END        (3173)
#define TLT_SIGNATURE_MULTI_LIST_KEYS_END          (3174)

#define TLT_SIGNATURE_GET_SIZE_START               (3181)
#define TLT_SIGNATURE_GET_SIZE_END                 (3182)

#define TLT_SIGNATURE_MULTI_GET_SIZE_START         (3191)
#define TLT_SIGNATURE_ORDERED_GET_SIZE_START       (3192)
#define TLT_SIGNATURE_ORDERED_GET_SIZE_END         (3193)
#define TLT_SIGNATURE_MULTI_GET_SIZE_END           (3194)
