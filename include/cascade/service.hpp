...
#define ACTION_BUFFER_SIZE          (1024)
    ...
    public:
        ...
        put(const typename SubgroupType::ObjectType& object,
    ...
    protected:
        ...
        derecho::rpc::QueryResults<std::tuple<persistent::version_t,persistent::version_t,persistent::version_t,uint64_t>> type_recursive_put(
                uint32_t type_index,
    ...
    public:
        ...
        derecho::rpc::QueryResults<std::tuple<persistent::version_t,persistent::version_t,persistent::version_t,uint64_t>> put(const ObjectType& object);
    ...
    protected:
        ...
        derecho::rpc::QueryResults<std::tuple<persistent::version_t,persistent::version_t,persistent::version_t,uint64_t>> type_recursive_remove(
                uint32_t type_index,
                const KeyType& key,
                uint32_t subgroup_index,
                uint32_t shard_index);
    ...
    public:
         ...
         */
        template <typename KeyType>
        derecho::rpc::QueryResults<std::tuple<persistent::version_t,persistent::version_t,persistent::version_t,uint64_t>> remove(const KeyType& key);
    ...
    public:
         ...
         */
        template <typename SubgroupType>
        derecho::rpc::QueryResults<std::tuple<persistent::version_t,persistent::version_t,persistent::version_t,uint64_t>> create_object_pool(
         ...
         * @return a future to the version, previous_version, previous_version_by_key, and timestamp of the put operation.
         */
        derecho::rpc::QueryResults<std::tuple<persistent::version_t,persistent::version_t,persistent::version_t,uint64_t>> remove_object_pool(const std::string& pathname);
