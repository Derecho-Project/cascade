 ...
 */
JNIEXPORT jobject JNICALL Java_io_cascade_Client_getShardMembers__JJ
 ...
 */
JNIEXPORT jobject JNICALL Java_io_cascade_Client_getShardMembers__Lio_cascade_ServiceType_2JJ
